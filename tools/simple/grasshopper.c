...
void grasshopper_encrypt (char *buf, size_t size, Key key)
{
    Key first_x_key;
...
static void apply_x (Block *block, Key key) {}

static void encrypt_block (Block *block, Key first, Key second) {}

...
static void encrypt_block (Block *block, const Key *key);
static void decrypt_block (Block *block, const Key *key);

static void generate_keys (Keys_Array keys, const Key *key);
